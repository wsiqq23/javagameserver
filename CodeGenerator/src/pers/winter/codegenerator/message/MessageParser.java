 ...
 * under the License.
 */
package pers.winter.codegenerator.message;
...
public class MessageParser {
    ...
    public void parse(Element entityElement) throws Exception {
        ...
        generateMessage(entityElement, fields);
    }
    ...
    private void generateMessage(Element messageElement, List<Field> fields) throws Exception {
